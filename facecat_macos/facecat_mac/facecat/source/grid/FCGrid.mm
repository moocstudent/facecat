...
namespace FaceCat{
    ...
    FCGrid::~FCGrid(){
        ...
        if(m_editTextBox){
            if (m_editTextBoxLostFocusEvent){
                m_editTextBox->removeEvent((Object)m_editTextBoxLostFocusEvent, FCEventID::LOSTFOCUS);
                m_editTextBoxLostFocusEvent = 0;
            }
            if(m_editTextBoxKeyDownEvent){
                m_editTextBox->removeEvent((Object)m_editTextBoxKeyDownEvent, FCEventID::KEYDOWN);
    ...
    void FCGrid::onCellEditBegin(FCGridCell *cell){
        ...
        if (!m_editTextBox){
            ...
            m_editTextBox->addEvent((Object)m_editTextBoxLostFocusEvent, FCEventID::LOSTFOCUS, this);
            m_editTextBox->addEvent((Object)m_editTextBoxKeyDownEvent, FCEventID::KEYDOWN, this);
    ...
    void FCGrid::removeRow(FCGridRow *row){
        ...
        if (selectedRowsSize > 1 && selected){
