    ...
    void TimeDiv::onLoad(){
        if (m_calendar){
            if (!m_spinHour){
                ...
                m_spinHour->addEvent((Object)selectedTimeChanged, FCEventID::VALUECHANGED, this);
            }
            if (!m_spinMinute){
                ...
                m_spinMinute->addEvent((Object)selectedTimeChanged, FCEventID::VALUECHANGED, this);
            }
            if (!m_spinSecond){
                ...
                m_spinSecond->addEvent((Object)selectedTimeChanged, FCEventID::VALUECHANGED, this);
            }
        }
    }
