...
namespace FaceCat{
    ...
    FCScrollBar::~FCScrollBar(){
        ...
        if (m_addButton){
            if (m_addButtonTouchDownEvent){
                m_addButton->removeEvent((Object)m_addButtonTouchDownEvent, FCEventID::TOUCHDOWN);
                m_addButtonTouchDownEvent = 0;
            }
            if (m_addButtonTouchUpEvent){
                m_addButton->removeEvent((Object)m_addButtonTouchUpEvent, FCEventID::TOUCHUP);
                m_addButtonTouchUpEvent = 0;
            }
        }
        if (m_scrollButton){
            if (m_scrollButtonDraggingEvent){
                m_scrollButton->removeEvent((Object)m_scrollButtonDraggingEvent, FCEventID::DRAGGING);
                m_scrollButtonDraggingEvent = 0;
            }
        }
        if (m_reduceButton){
            if (m_reduceButtonTouchDownEvent){
                m_reduceButton->removeEvent((Object)m_reduceButtonTouchDownEvent, FCEventID::TOUCHDOWN);
                m_reduceButtonTouchDownEvent = 0;
            }
            if (m_reduceButtonTouchUpEvent){
                m_reduceButton->removeEvent((Object)m_reduceButtonTouchUpEvent, FCEventID::TOUCHUP);
    ...
    void FCScrollBar::onAddSpeedScrollStart(uint64_t startTime, uint64_t nowTime, int start, int end){
        ...
        if (diff > 0 && diff < 800){
            int sub = 200 * ((abs(start - end)) / 20) / diff * 10;
    ...
    void FCScrollBar::onLoad(){
        ...
        if (!m_addButton){
            ...
            m_addButton->addEvent((Object)m_addButtonTouchDownEvent, FCEventID::TOUCHDOWN, this);
            m_addButton->addEvent((Object)m_addButtonTouchUpEvent, FCEventID::TOUCHUP, this);
        ...
        if (!m_reduceButton){
            ...
            m_reduceButton->addEvent((Object)m_reduceButtonTouchDownEvent, FCEventID::TOUCHDOWN, this);
            m_reduceButton->addEvent((Object)m_reduceButtonTouchUpEvent, FCEventID::TOUCHUP, this);
            addControl(m_reduceButton);
        }
        if (!m_scrollButton){
            m_scrollButton = dynamic_cast<FCButton*>(host->createInternalControl(this, L"scrollbutton"));
            m_scrollButton->addEvent((Object)m_scrollButtonDraggingEvent, FCEventID::DRAGGING, this);
