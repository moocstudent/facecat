...
namespace FaceCat{
	...
	public:
		FCClientSocket(int type, long proxyType, string ip, u_short port, string proxyIp, u_short proxyPort, string proxyUserName, string proxyUserPwd, string proxyDomain, int timeout);
