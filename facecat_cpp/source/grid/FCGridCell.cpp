...
namespace FaceCat{
	...
	void FCGridControlCell::onAdd(){
	    ...
	    if (m_control && grid){
			...
			m_control->addEvent(m_touchDownEvent, FCEventID::TOUCHDOWN, this);
			m_control->addEvent(m_touchMoveEvent, FCEventID::TOUCHMOVE, this);
			m_control->addEvent(m_touchUpEvent, FCEventID::TOUCHUP, this);
			m_control->addEvent(m_touchWheelEvent, FCEventID::TOUCHWHEEL, this);
        }
	}
